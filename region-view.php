...
$result_item_status = $user->getItemStatus($_GET["item_id"]);
              ...
              <table style="width:80%">
                ...
                <tbody>
                  <?php
                    ...
                    <!-- <td> <?php echo $array_item_status["data"][$a]["is_id"]; ?></td> -->
                     <td> <?php echo $array_item_status["data"][$a]["status_desc"]; ?></td>
                      <!-- <td> <?php echo $array_item_status["data"][$a]["is_region_from"]; ?></td> -->

                      <?php
                      if( $array_item_status["data"][$a]["region_name"] != ""){
                        $region_name =  $array_item_status["data"][$a]["region_name"];
                      }else{
                        $region_name = "Null";
                      }
                          ?> 
