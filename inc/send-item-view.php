                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                           <li class="breadcrumb-item"><a href="send-to-region-list.php">Item List</a></li>
                ...
                <div class="parallel_content">
                  ...
                  <?php
                    if($array_item_detail["valid"]){
                      ...
                      <p class="parallel_text_right">: <?php echo $array_item_detail["asset_name"]; ?></p>

                      <p class="parallel_text_left">Barcode</p>
                      <p class="parallel_text_right">: <?php echo $array_item_detail["barcode"]; ?></p>
                      ...
                      <p class="parallel_text_right">: <?php echo $array_item_detail["lastModifiedBy"]; ?></p>

                      <p class="parallel_text_left">Last Modified Date</p>
                      <p class="parallel_text_right">: <?php echo $array_item_detail["lastModifiedDt"]; ?></p> -->
