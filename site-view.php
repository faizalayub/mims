...
$result_item_status = $user->getItemSiteStatus($_GET["item_id"]);
$array_item_status = json_decode($result_item_status,true);

$result_site_status = $user->getSiteStatusByID($_GET["item_id"]);
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                           <li class="breadcrumb-item"><a href="site-list.php">Item List</a></li>
