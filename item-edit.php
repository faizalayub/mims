...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="parallel_content">
                  ...
                  <?php
                    if($array_item_detail["valid"]){
                      ...
                      <p class="parallel_text_right"> 
                        <input type="text" name="createdBy" id="createdBy" class="form-control" value="<?php echo $array_item_detail["createdBy"]; ?>"></p>
      ...
      function submit(){
		...
		//HK 150621 - add status != 5(Received). Coz sender Send to RegionX, RegionX to update status Received 
        if ((region_from == region_id) && (status_id != 5)){
          swal({
                    type:'error',
                    title:'error!',
                    html:"Same Location"
