...
$result_item = $user->getSendItemsSubregionToSiteListOnLoad($_SESSION['location']);
...
<html>
   ...
   <!-- <body class="hold-transition sidebar-mini layout-fixed" onload="getSendItemsSubregionToSiteListOnLoad();"> -->
                      ...
                      if($array_item["valid"]){
                        ...
                        for($a=0;$a<count($array_item["data"]);$a++){
                          ...
                          <tr>
                                  ...
                                  <td><?php echo $array_item["data"][$a]["agency_desc"]; ?></td>
                                  <td><?php echo $array_item["data"][$a]["site_desc"]; ?></td>
                                  <td>
                                    <a href="subregion-view.php?item_id=<?php echo $array_item["data"][$a]["item_id"]; ?>" target="" style="color:#000">
                                      <i class="material-icons">pageview</i></a> | <a href="subregion-to-site.php?item_id=<?php echo $array_item["data"][$a]["item_id"]; ?>" target="" style="color:#000">
      ...
      <script src="https://cdn.datatables.net/1.10.22/js/dataTables.bootstrap4.min.js"></script>
         <script>
         function getSendItemsSubregionToSiteListOnLoad(){

         var location = $("#location").val();
         var formData = new FormData()

         formData.append("action","getSendItemsSubregionToSiteListOnLoad");
         formData.append("location", location)
      
        $.ajax({
          type:'post',
          url:'action2.php',
          data:{"action":"getSendItemsSubregionToSiteListOnLoad"},
