...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed" onload="getSendItemsListOnLoad();">
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Send Item List</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
      ...
      <script src="https://cdn.datatables.net/1.10.22/js/dataTables.bootstrap4.min.js"></script>
         <script>
         function getSendItemsListOnLoad(){
      
        $.ajax({
          type:'post',
          url:'action2.php',
          data:{"action":"getSendItemsListOnLoad"},
