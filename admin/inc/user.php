<?php
    ...
    class Users{
     ...
     public function addItem($array){
            ...
            $args_add = array("serial_no" => $array["serial_no"], "model_id" => $array["model_id"], "brand_id" => $array["brand_id"], "category_id" => $array["category_id"], "createdBy" => $array["createdBy"],  "region_id" => $array["region_id"]);


            $sql_add = "INSERT INTO item SET serial_no = :serial_no, model_id = :model_id, brand_id = :brand_id, category_id = :category_id, createdBy = :createdBy, region_id = :region_id";
    ...
    public function getSendItemsListOnLoad(){
        ...
        if($result-> rowCount() > 0 ){
            ...
            foreach ($result as $key => $value) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;">'.$value["createdDt"].'</td>
                    <td style="text-align: center;">'.$value["lastModifiedDt"].'</td>
                    <td style="text-align: center;">'.$value["region_name"].'</td>
                ...
                $tableOnLoad .='
                    ...
                    <td style="text-align: center;">
                    <button><a href="item-transfer.php?item_id='.$value["item_id"].'" target="" style="color:#000"><i class="material-icons">edit</i></a></button>
                    </td>
                </tr>
                ';
            }
        ...
        public function getItemListOnLoad(){
        ...
        $args = array("item_id" => $array["item_id"], "serial_no" => $array["serial_no"],"model_id" => $array["model_id"], "brand_id" => $array["brand_id"], "category_id" => $array["category_id"], "createdBy" => $array["createdBy"], "createdDt" => $array["createdDt"], "lastModifiedBy" => $array["lastModifiedBy"], "lastModifiedDt" => $array["lastModifiedDt"], "region_id" => $array["region_id"], "status_id" => $array["status_id"]);        

        $sql = "UPDATE item SET serial_no = :serial_no, model_id = :model_id, brand_id = :brand_id, category_id = :category_id, createdBy = :createdBy, createdDt = :createdDt, lastModifiedBy = :lastModifiedBy, lastModifiedDt = :lastModifiedDt, region_id = :region_id, status_id = :status_id WHERE item_id = :item_id";
    ...
    public function getItemsDetailByID($item_id){
        ...
        $args = array("item_id" => $array["item_id"], "serial_no" => $array["serial_no"],"model_id" => $array["model_id"], "brand_id" => $array["brand_id"], "category_id" => $array["category_id"], "agency_id" => $array["agency_id"], "createdDt" => $array["createdDt"], "lastModifiedDt" => $array["lastModifiedDt"], "region_id" => $array["region_id"], "status_id" => $array["status_id"], "site_id" => $array["site_id"]);        

        $sql = "UPDATE item SET serial_no = :serial_no, model_id = :model_id, brand_id = :brand_id, category_id = :category_id, agency_id = :agency_id, createdDt = :createdDt,  lastModifiedDt = :lastModifiedDt, region_id = :region_id, status_id = :status_id, site_id = :site_id WHERE item_id = :item_id";
    ...
    public function updateFaulty($array){
        ...
        $args = array("item_id" => $array["item_id"], "status_id" => $array["status_id"]);        

        $sql = "UPDATE item SET status_id = :status_id WHERE item_id = :item_id";
        ...
        if($result-> rowCount() > 0 ){
            ...
            foreach ($result as $key => $value) {
                ...
                $tableOnLoad .='
                    ...
                    <td style="text-align: center;">
                    <button><a href="faulty-record-view.php?item_id='.$value["item_id"].'" target="" style="color:#000"><i class="material-icons">pageview</i></a> | <a href="faulty-record-edit.php?item_id='.$value["item_id"].'" target="" style="color:#000"><i class="material-icons">edit</i></a> | <a id='.$value["item_id"].' onclick="deleteItem(this.id);" style="color:#000"> <i class="material-icons">delete</i></a></button>
                    </td>
                </tr>
                ';
            }
