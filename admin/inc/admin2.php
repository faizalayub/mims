    ...
    class Admins{
        ...
        public function checkAdminLogin($array){
         ...
         public function addUser($array){
            ...
            $args_add = array("user_id" => $array["user_id"], "username" => $array["username"],"department" => $array["department"], "password" => $array["password"], "role_id" => $array["role_id"], "location" => $array["location"]);


            $sql_add = "INSERT INTO user SET user_id = :user_id, user_name = :username, user_department = :department, user_password = :password, role_id = :role_id, location = :location";
        ...
        $sql = "SELECT * FROM user
         LEFT JOIN region ON user.location = region.region_id
