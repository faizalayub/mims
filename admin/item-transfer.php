...
$result_agency = $admin->getAgency();
$array_agency = json_decode($result_agency, true);

$result_site = $admin->getSite();
$array_site = json_decode($result_site, true);
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                           <li class="breadcrumb-item"><a href="item-send-list.php">Send Item List</a></li>
                ...
                <div class="parallel_content">
                  ...
                  <?php
                    if($array_item_detail["valid"]){
                      ...
                      <p class="parallel_text_right">                        
                       <select class="form-control" id="agency_id">
                        <option value="0" selected disabled="">Select Agency</option>
                        <?php for($i = 0; $i < count($array_agency["data"]); $i++){?>
                         <option value="<?php echo $array_agency["data"][$i]["agency_id"];?>"
                          <?php echo $array_item_detail["agency_id"] == $array_agency["data"][$i]["agency_id"] ? "selected" : ""; ?>><?php echo $array_agency["data"][$i]["agency_desc"]; ?></option>
                        <?php } ?>
                       </select>
                      ...
                      <p class="parallel_text_right"> 
                        <input type="text" name="lastModifiedDt" class="form-control" id="lastModifiedDt" value="<?php echo $array_item_detail["lastModifiedDt"]; ?>" ></p>

                      <p class="parallel_text_left">Location</p>
                      <input type="hidden" name="region" id="region"class="form-control"  value="<?php echo $array_item_detail["region_id"]?>">
                      <p class="parallel_text_right"> 
                        ...
                        <?php for($i = 0; $i < count($array_region["data"]); $i++){?>
                         <option value="<?php echo $array_region["data"][$i]["region_id"];?>"
                          ...
                          <?php echo $array_item_detail["region_id"] == $array_region["data"][$i]["region_id"] ? "selected" : ""; ?>><?php echo $array_region["data"][$i]["region_name"]; ?></option>
                        <?php } ?>
                       </select>
                      ...
                      <p class="parallel_text_right">                   
                       <select class="form-control" id="site_id">
                        ...
                        <?php for($i = 0; $i < count($array_site["data"]); $i++){?>
                         <option value="<?php echo $array_site["data"][$i]["site_id"];?>"
                          <?php echo $array_item_detail["site_id"] == $array_site["data"][$i]["site_id"] ? "selected" : ""; ?>><?php echo $array_site["data"][$i]["site_desc"]; ?></option>
                        <?php } ?>
                       </select>
                  ...
                  <div align="right">
                      <button class="btn btn-danger general_btn" onclick="window.location.href='item-send-list.php'">Cancel</button>
                ...
                if(result_obj.valid){
                  swal({
                    ...
                    html:result_obj.msg
                     ...
                     window.location = "item-send-list.php";
                    });
