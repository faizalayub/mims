...
$result_item_detail = $admin->getSendItemsDetailByID($_GET["item_id"]);
...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                           <li class="breadcrumb-item"><a href="site-list.php">Send Item List</a></li>
               ...
               <div class="container-fluid">
                ...
                <div class="parallel_content">
                  ...
                  <?php
                    ...
                    <select class="form-control agency_id" id="agency_id">
                        ...
                        <?php for($i = 0; $i < count($array_agency["data"]); $i++){?>
                         <option value="<?php echo $array_agency["data"][$i]["agency_id"];?>"
                          <?php echo $array_item_detail["is_agency_id"] == $array_agency["data"][$i]["agency_id"] ? "selected" : ""; ?>><?php echo $array_agency["data"][$i]["agency_desc"]; ?></option>
                        <?php } ?>
                       </select> 
                      ...
                      <p class="parallel_text_right">  
                      <select class=" form-control nice area site_id" name="site_id" id="site_id">
                  ...
                  <div align="right">
                      <button class="btn btn-danger general_btn" onclick="window.location.href='site-list.php'">Cancel</button>
      ...
      function submit(){
        ...
        formData.append("action","updateItemSite");
        ...
        if(agency_id == "" || site_id == "" ){
          swal({
                    type:'error',
                    title:'error!',
                    html:"Please select Agency and Site"
                   }).then(function(){
                  });
        }else{
          $.ajax({
...
$(document).ready(function(){
    $('#agency_id').on('change',function(){
        ...
        if(agencyid){
            ...
            $('#site_id').html('<option value="">-- Please Select State First --</option>');
