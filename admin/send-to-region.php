                ...
                <div class="parallel_content">
                  ...
                  <?php
                    if($array_item_detail["valid"]){
                      ...
                      <input type="hidden" name="region" id="region_from" class="form-control" value="<?php echo $array_item_detail["region_id"]?>">
<!--                        <input type="text" name="region" id="is_id" class="form-control" value="<?php echo $array_item_detail["is_id"]?>">
 -->                      <p class="parallel_text_right">
