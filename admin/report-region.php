...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed" onload="getItemListByRegionOnLoad();">
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Item List By Region</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
      ...
      <script src="https://cdn.datatables.net/buttons/1.5.6/js/buttons.html5.min.js"></script>
         <script>
         function getItemListByRegionOnLoad(){
      
        $.ajax({
          type:'post',
          url:'action.php',
          data:{"action":"getItemListByRegionOnLoad"},
