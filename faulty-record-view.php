...
$result_item_detail = $user->getItemsDetailByID($_GET["item_id"]);
$array_item_detail = json_decode($result_item_detail,true);


$result_item_status = $user->getItemFaultyStatus($_GET["item_id"]);
$array_item_status = json_decode($result_item_status,true);

$result_site_status = $user->getFaultyStatusByID($_GET["item_id"]);
$array_site_status = json_decode($result_site_status,true);
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                           <li class="breadcrumb-item"><a href="faulty-list.php">Item List</a></li>
                ...
                <div class="parallel_content">
                  ...
                  <?php
                    if($array_item_detail["valid"]){
                      ...
                      <p class="parallel_text_right">: <?php echo $array_site_status["status_desc"]; ?></p>                  
                      ...
                      <p class="parallel_text_right">: <?php echo $array_item_detail["is_region_current"]; ?></p> -->
                ...
                <tbody>
                  <?php
                    ...
                    <td> <?php echo $array_item_status["data"][$a]["is_datetime"]; ?></td>
                     ...
                     <?php
                      if( $array_item_status["data"][$a]["agency_desc"] != ""){
                        $agency_desc =  $array_item_status["data"][$a]["agency_desc"];
                      }else{
                        $agency_desc = "Null";
                      }
                          ?>
                     <td> <?php echo $agency_desc; ?></td>      
                      ...
                      <?php
                      if( $array_item_status["data"][$a]["site_desc"] != ""){
                        $site_desc =  $array_item_status["data"][$a]["site_desc"];
                      }else{
                        $site_desc = "Null";
                      }
                          ?>               
